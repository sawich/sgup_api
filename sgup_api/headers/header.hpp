...
extern "C" __declspec(dllexport) int SGUPAPI_GetAuthToken(void)
{
...
extern "C" __declspec(dllexport) char* SGUPAPI_GetCurrentAccessToken(void)
{
  std::cout << "[SGUPAPI_GetCurrentAccessToken] call\n";

  std::string_view token{ SGUPAPI_GetCurrentAccessToken_external() };
...
extern "C" __declspec(dllexport) int SGUPAPI_GetMessengerAuthToken(void)
{
...
using SGUPAPI_Init_t = char(*)(void);
SGUPAPI_Init_t SGUPAPI_Init_external;
extern "C" __declspec(dllexport) char SGUPAPI_Init(void)
{
...
extern "C" __declspec(dllexport) int SGUPAPI_RenewAuthToken(void)
{
...
extern "C" __declspec(dllexport) int SGUPAPI_RenewMessengerAuthToken(void)
{
...
extern "C" __declspec(dllexport) int SGUPAPI_RunCallback(void)
{
...
using SGUPAPI_SetCallback_t = DWORD * (*)(void);
SGUPAPI_SetCallback_t SGUPAPI_SetCallback_external;
extern "C" __declspec(dllexport) DWORD * SGUPAPI_SetCallback(void)
{
...
extern "C" __declspec(dllexport) int SGUPAPI_Term(void)
{
...
extern "C" __declspec(dllexport) int SGUPFriends(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_GetMemberInfo(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_InternalRenewAuthToken(void)
{
...
using SGUPIAPI_MessengerInit_t = bool(*)(void);
SGUPIAPI_MessengerInit_t SGUPIAPI_MessengerInit_external;
extern "C" __declspec(dllexport) bool SGUPIAPI_MessengerInit(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_MessengerTerm(void)
{
...
using SGUPIAPI_OverlayHostInit_t = bool(*)(void);
SGUPIAPI_OverlayHostInit_t SGUPIAPI_OverlayHostInit_external;
extern "C" __declspec(dllexport) bool SGUPIAPI_OverlayHostInit(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_OverlayHostTerm(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_SendDuplicateLoginEvent(void)
{
...
using SGUPIAPI_SetCallback_t = void(*)(void);
SGUPIAPI_SetCallback_t SGUPIAPI_SetCallback_external;
extern "C" __declspec(dllexport) void SGUPIAPI_SetCallback(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_SetCallbackDuplicateLoginResult(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_SetCallbackGetMemberInfo(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_SetCallbackInternalRenewAuthToken(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_SetCallbackMessengerConfigUpdate(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_SetCallbackSubscriptReq(void)
{
...
extern "C" __declspec(dllexport) int SGUPIAPI_SetCallbackUpdateAuthToken(void)
{
...
extern "C" __declspec(dllexport) int SGUPMatchMaking(void)
{
...
extern "C" __declspec(dllexport) int SGUPOverlay(void)
{
...
extern "C" __declspec(dllexport) int SGUPPeerToPeer(void)
{
...
extern "C" __declspec(dllexport) int SGUPUser(void)
{
